...
insert  into `auths`(`id`,`name`,`description`) values (1,'Auths (Create)','Auths (Create)'),(2,'Auths (Read)','Auths (Read)'),(3,'Auths (Update)','Auths (Update)'),(5,'Auths (Delete)','Auths (Delete)'),(6,'Products (Create)','Products (Create)'),(7,'Products (Read)','Products (Read)'),(8,'Products (Update)','Products (Update)'),(9,'Products (Delete)','Products (Delete)'),(10,'UserAuths (Create)','UserAuths (Create)'),(11,'UserAuths (Update)','UserAuths (Update)'),(12,'UserAuths (Delete)','UserAuths (Delete)'),(13,'UserAuths (Read)','UserAuths (Read)'),(14,'RoleAuths (Create)','RoleAuths (Create)'),(15,'RoleAuths (Update)','RoleAuths (Update)'),(16,'RoleAuths (Delete)','RoleAuths (Delete)'),(17,'RoleAuths (Read)','RoleAuths (Read)'),(19,'Store (Create)','Store (Create)'),(20,'Store (Read)','Store (Read)'),(21,'Store (Delete)','Store (Delete)'),(22,'Store (Update)','Store (Update)'),(23,'Users (Create)','Users (Create)'),(24,'Users (Read)','Users (Read)'),(25,'Users (Update)','Users (Update)'),(26,'Users (Delete)','Users (Delete)'),(27,'Store Products (Create)','Store Products (Create)'),(28,'Store Products (Read)','Store Products (Read)'),(29,'Store Products (Update)','Store Products (Update)'),(30,'Store Products (Delete)','Store Products (Delete)'),(31,'Orders (Read)','Orders (Read)'),(32,'Orders (Delete)','Orders (Delete)'),(33,'Orders (Update)','Orders (Update)'),(35,'Orders (Create)','Orders (Create)'),(36,'Store User (Create)','Store User (Create)'),(37,'Store User (Read)','Store User (Read)'),(38,'Store User (Update)','Store User (Update)'),(39,'Store User (Delete)','Store User (Delete)'),(40,'User Role (Create)','User Role (Create)'),(41,'User Role (Read)','User Role (Read)'),(42,'User Role (Update)','User Role (Update)'),(43,'User Role (Delete)','User Role (Delete)'),(44,'Store Application (Create)','Store Application (Create)'),(45,'Store Application (Read)','Store Application (Read)'),(46,'Store Application (Update)','Store Application (Update)'),(47,'Store Application (Delete)','Store Application (Delete)'),(48,'Store User Auth (Read)','Store User Auth (Read)'),(49,'Store User Auth (Create)','Store User Auth (Create)'),(50,'Store User Auth (Delete)','Store User Auth (Delete)'),(51,'Store User Auth (Modify)','Store User Auth (Modify)');
...
insert  into `orderproducts`(`orderId`,`storeId`,`productId`,`count`,`isAvailable`,`price`) values (19,7,75,2,'true',22),(19,7,76,3,'true',51.57),(20,7,75,8,'true',22),(20,7,76,5,'true',51.57),(20,7,77,2,'true',56.9),(20,7,78,2,'true',4),(20,7,79,3,'true',3),(20,7,80,1,'false',0),(21,7,75,1,'true',22),(21,7,76,2,'true',51.57),(21,7,81,2,'true',5);
...
insert  into `orders`(`id`,`userId`,`fullName`,`address`,`contact`,`status`,`storeId`,`date`,`totalprice`,`storeuserIdProcess`,`storeuserIdDeliver`) values (19,59,'christine rose bulayo','marawis, valencia, bohol','0900909090909','canceled',7,'2020-09-21 13:51:44',198.71,110,110),(20,59,'gieford taga-an','tangnana, panglao bohol','09463645489','done',7,'2020-09-21 14:39:58',564.65,110,110),(21,59,'renzo','sagbay','0909','done',7,'2020-10-05 01:29:45',135.14,110,110);
...
insert  into `roleauths`(`authId`,`role`) values (1,'superadmin'),(2,'superadmin'),(3,'superadmin'),(5,'superadmin'),(6,'superadmin'),(7,'superadmin'),(7,'user'),(8,'superadmin'),(9,'superadmin'),(10,'superadmin'),(11,'superadmin'),(12,'superadmin'),(13,'superadmin'),(14,'superadmin'),(15,'superadmin'),(16,'superadmin'),(17,'superadmin'),(19,'superadmin'),(20,'superadmin'),(21,'superadmin'),(22,'superadmin'),(23,'superadmin'),(24,'superadmin'),(25,'superadmin'),(26,'superadmin'),(27,'superadmin'),(27,'storeuser'),(27,'storeowner'),(28,'superadmin'),(28,'storeuser'),(28,'storeowner'),(29,'superadmin'),(29,'storeuser'),(29,'storeowner'),(30,'superadmin'),(30,'storeuser'),(30,'storeowner'),(31,'superadmin'),(31,'storeuser'),(31,'storeowner'),(32,'superadmin'),(32,'storeuser'),(32,'storeowner'),(33,'superadmin'),(33,'storeuser'),(33,'storeowner'),(35,'storeuser'),(36,'storeowner'),(37,'storeowner'),(38,'storeowner'),(39,'storeowner'),(48,'storeowner'),(49,'storeowner');
...
insert  into `stores`(`id`,`name`,`location`,`owner`,`isdisabled`) values (6,'Grocery-BQ','tagb','Bq','false'),(7,'Alturas Gorcery','tagb','Alturas','false'),(8,'Aturas Home Fashion','Tagb','Alturas','false'),(14,'Renzo Store','Sagbayan','Renzo','true');
...
insert  into `userauths`(`authId`,`userId`) values (000000000000001,59),(000000000000002,59),(000000000000003,59),(000000000000005,59),(000000000000006,59),(000000000000007,59),(000000000000007,110),(000000000000008,59),(000000000000009,59),(000000000000010,59),(000000000000012,59),(000000000000013,59),(000000000000014,59),(000000000000016,59),(000000000000017,59),(000000000000019,59),(000000000000022,59),(000000000000023,59),(000000000000024,59),(000000000000025,59),(000000000000026,59),(000000000000027,59),(000000000000027,110),(000000000000027,113),(000000000000027,125),(000000000000028,59),(000000000000028,110),(000000000000028,113),(000000000000028,125),(000000000000029,59),(000000000000029,110),(000000000000029,113),(000000000000029,125),(000000000000030,59),(000000000000030,110),(000000000000030,113),(000000000000030,125),(000000000000031,59),(000000000000031,110),(000000000000031,113),(000000000000031,125),(000000000000032,59),(000000000000032,110),(000000000000032,113),(000000000000032,125),(000000000000033,59),(000000000000033,110),(000000000000033,113),(000000000000033,125),(000000000000035,125),(000000000000036,59),(000000000000036,110),(000000000000036,113),(000000000000037,110),(000000000000037,113),(000000000000038,59),(000000000000038,110),(000000000000038,113),(000000000000039,110),(000000000000039,113),(000000000000042,59),(000000000000045,59),(000000000000046,59),(000000000000048,110),(000000000000049,110),(000000000000050,110),(000000000000051,110);
...
insert  into `users`(`id`,`first_name`,`last_name`,`email`,`password`,`role`,`created`,`storeId`) values (00000000059,'Gieford','Taga-an','admin','$2b$10$obXzsyY2Y232va0WxGHB9eVKnEspiG98vBg9WTLdB3Z7ieir29brC','superadmin','2020-09-01 05:04:45',-1),(00000000110,'user2gihapon','user2gihapon','user2','$2b$10$xOG0JBdCNoqdtmPYI73KteZfyX8m2FMcA1m7Ye3eDPUvj3gfglLLG','storeowner','2020-09-17 13:07:16',7),(00000000113,'renzo','renzo','renzo','$2b$10$pQuKiqo7PsozItYZ1F4lSOziWHJgCCEXGuj0iEYVyh1gyOpcmh8/2','storeowner','2020-09-23 03:41:34',14),(00000000125,'user22','user22','user22','$2b$10$ADRAJMya38xaW.zRMAulj.EYtRIRQTkjsJn2rv6o25qZQ/dgad3Ca','storeuser','2020-10-03 01:30:43',7);
