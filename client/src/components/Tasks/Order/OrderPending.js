    ...
    return (
        <div id="orderPendingDiv">
          ...
          <table className="responsiveTable">
            ...
            <tbody>
                {this.props.orderPendingDatalist.map((data,i)=>{
                  return (
                    <tr key={i} className="table-list" >
                      ...
                      <td>
                        <button id={data.id} onClick={this.props.onAcceptOrder}>Accept Order</button>
                        <button id={data.id} onClick={this.props.onRejectOrder}>Cancel Order</button>
                      </td>
